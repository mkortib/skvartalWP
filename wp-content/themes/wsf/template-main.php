...
<main class="main-slide wrap" id="main_slide">

    <section class="section first" id="change">
        <div class="slide_header">
            <h2><?php echo __('[:ua]Сучасний квартал - місце, створене для вас з любов’ю[:ru]Современный квартал - место, созданное для вас с любовью[:]'); ?></h2>
            <p><?php echo __('[:ua]Сучасний квартал в Солом\'янському районі міста Києва, житловий масив Відрадний.[:ru]Современный квартал в Соломенском районе города Киева, жилой массив Отрадный.[:]') ?></p>
            <a href="/layouts/" class="button"><?php echo __('[:ua]Переглянути планування[:ru]Посмотреть планировки[:]') ?></a>
        </div>
    </section>
    <section class="section">
        <div class="slide_header">
            <h2><?php echo __('[:ua]Сучасний квартал - квартал нового покоління[:ru]Современный квартал - квартал нового поколения[:]'); ?></h2>
            <p><?php echo __('[:ua]Ми продумали його архітектуру, інтер\'єри, планування, розташування і створили по-справжньому здорове середовище для дорослих і маленьких жителів.[:ru]Мы продумали его архитектуру, интерьеры, планировки и расположение и создали по-настоящему здоровую среду для взрослых и маленьких жителей.[:]') ?></p>
            <a href="/layouts/" class="button"><?php echo __('[:ua]Переглянути планування[:ru]Посмотреть планировки[:]') ?></a>
        </div>
    </section>
    <section class="section">
        <div class="slide_header">
            <h2><?php echo __('[:ua]Сучасний квартал - територія для тих, хто цінує спокій[:ru]Современный квартал - територия для тех, кто ценит спокойствие[:]'); ?></h2>
            <p><?php echo __('[:ua]Закриті двори комплексу дозволять вам уникнути найменшого занепокоєння і проводити час із задоволенням.[:ru]Закрытые дворы комплекса позволят вам избежать малейшего беспокойства и проводить время с удовольствием.[:]') ?></p>
            <a href="/layouts/" class="button"><?php echo __('[:ua]Переглянути планування[:ru]Посмотреть планировки[:]') ?></a>
        </div>
    </section>
    <section class="section">
        <div class="slide_header">
            <h2><?php echo __('[:ua]Сучасний квартал - це щасливе дитинство для меленьких мешканців[:ru]Современный квартал - это счастливое детство для маленьких жителей[:]'); ?></h2>
            <p><?php echo __('[:ua]Щасливі діти - щасливі батьки. Знаючи цю просту формулу, ми побудували комплекс в розвиненому районі і створили на його території прекрасну дитячу інфраструктуру.[:ru]Счастливые дети — счастливые родители. Зная эту простую формулу, мы построили комплекс в развитом районе и создали на его территории прекрасную детскую инфраструктуру.[:]') ?></p>
            <a href="/layouts/" class="button"><?php echo __('[:ua]Переглянути планування[:ru]Посмотреть планировки[:]') ?></a>
        </div>
    </section>
...
<div class="slider_mobile">
    ...
    <section>
        <div class="slide_header">
            <h2><?php echo __('[:ua]Сучасний квартал - це щасливе дитинство для меленьких мешканців[:ru]Современный квартал - это счастливое детство для маленьких жителей[:]'); ?></h2>
            <p><?php echo __('[:ua]Щасливі діти - щасливі батьки.[:ru]Счастливые дети — счастливые родители.[:]') ?></p>
            <a href="/layouts/" class="button"><?php echo __('[:ua]Переглянути планування[:ru]Посмотреть планировки[:]') ?></a>
        </div>
    </section>
...
<div class="zoom-anim-dialog mfp-hide" id="popup_form1">
    ...
    <form class="form_style form_pop_call">
        ...
        <h4><?php echo __('[:ua]Хотите мы вам перезвоним?[:ru]Хочете ми вам передзвонимо?[:]'); ?></h4>
...
<div id="del">
    ...
    <script>  $(".main-slide").onepage_scroll({sectionContainer: ".section"});$('.section').css('left', '310px');</script>
</div>
