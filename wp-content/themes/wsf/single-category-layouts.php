...
<!--                                        <li>--><?php //echo __('[:ru]Этаж[:ua]Поверх[:]'); ?><!--:</li>-->
                                        ...
                                        <li><?php echo __('[:ru]Прихожая[:ua]Прихожа[:]'); ?>:</li>
                                        <li><?php echo __('[:ru]Гардеробная[:ua]Гардеробна[:]'); ?>:</li>
                                        <li><?php echo __('[:ru]Ванная комната[:ua]Ванна кімната[:]'); ?>:</li>
                                        <li>Кухня:</li>
                                        <li><?php echo __('[:ru]Спальня[:ua]Спальня[:]'); ?>:</li>
                                        <li><?php echo __('[:ru]Лоджия[:ua]Лоджія[:]'); ?>:</li>
                                    </ul>
...
<!--                                        <li>--><?php //echo get_field('floors'); ?><!--</li>-->
                                ...
                                <div class="action_bl">
                                    ...
                                    <a href="<?php echo get_field('file')['url']; ?>" target="_blank" class="down_pl"><i class="fas fa-download"></i><?php echo __('[:ru]скачать PDF планировки[:ua]завантажити PDF планування[:]'); ?></a>
                                </div>
    ...
    <section class="s_help">
        ...
        <form class="calculate">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 col-xl-4 fl_cent fl_first">
                    <div class="cal_item">
